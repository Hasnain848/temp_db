...
-- ══════════════════════════════════════════════
-- ENROLLMENTS + GRADES for completed semesters
-- Uses a stored procedure approach to create both
-- ══════════════════════════════════════════════

-- Helper: enroll and grade in one step for completed courses
...
-- Get all student IDs into a temp table for easy reference
...
-- Get section IDs for Spring 2025
...
-- Enroll CS students in Spring 2025 CS101-A (completed with grades)
-- Using student_id directly from students table
...
-- Spring 2025 CS101 Section A — completed enrollments with grades
...
-- ══════════════════════════════════════════════
-- TIMETABLE for Fall 2026 (active semester)
-- ══════════════════════════════════════════════

-- Get Fall 2026 section IDs
SET @fa26 = (SELECT semester_id FROM semesters WHERE name='Fall 2026');

-- CS101 sections Fall 2026
